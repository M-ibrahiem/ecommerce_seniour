            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <form action="{{ route('dashboard.categories.update',$category->id) }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                         @method('PUT')
                         <img src="{{ asset('uploads/category/'.$category->image) }}" id="img-prv" width="250" height="250" alt="image">
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="name" value="{{ $category->name }}" type="text" class="form-control" id="exampleInputuname_1" placeholder="categoryname">
                            </div>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="sub_title" value="{{ $category->sub_title }}" type="text" class="form-control" id="exampleInputsub_title_1" placeholder="Enter sub_title">
                            </div>
                            @error('sub_title')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
