                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="collection-banner p-bottom p-center text-center">
                            <a href="shop-left-sidebar.html" class="banner-img">
                                <img src="{{ asset('uploads/category/' . $category->image) }}" class="bg-img blur-up lazyload"
                                    alt="">
                            </a>
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-style-3 product-style-chair">
                                <div class="product-title d-block mb-0">
                                    ...
                                    <p class="font-light mb-sm-2 mb-0">{{ $product->{'name_' . LaravelLocalization::getCurrentLocale()} }}</p>
                                    @else
                                    <p class="font-light mb-sm-2 mb-0">{{ $product->name}}</p>
                                    @endif
                                    {{-- <p class="font-light mb-sm-2 mb-0">{{ $product->{'name_' . app()->getLocale()} }}</p> --}}
